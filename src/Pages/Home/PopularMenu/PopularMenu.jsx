...
const PopularMenu = ({item}) => {
  ...
  return (
    <section className="mb-24 max-w-screen-xl mx-auto">
      <SectionTitle heading={"Popular Menu"} subHeading={"From Our Menu"}></SectionTitle>
      ...
      <p className="bg-[#111827] text-white absolute right-0 mr-8 mt-4 px-3 py-1 font-semibold">${item.price}</p>
